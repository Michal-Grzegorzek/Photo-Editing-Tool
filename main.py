...
def upload_image():
    ...
    canvas2.create_image(305, 270, image=photo_img)
...
def blur():
    ...
    canvas2.create_image(305, 270, image=photo_image)
...
# the creation of the four main buttons
btn_select = Button(my_w, text="Select Image", bg='#4649FF', fg='black', width=10,
              font='ariel 15 bold', relief=GROOVE, command=upload_image)
btn_select.place(x=365, y=620)

btn_reset = Button(my_w, text="Reset", bg='#4649FF', fg='black', width=10,
              font='ariel 15 bold', relief=GROOVE, command=reset)
btn_reset.place(x=515, y=620)

btn_save = Button(my_w, text="Save", bg='#54B435', fg='black', width=10,
              font='ariel 15 bold', relief=GROOVE, command=save)
btn_save.place(x=665, y=620)

btn_exit = Button(my_w, text="Exit", bg='#E14D2A', fg='black', width=10,
              font='ariel 15 bold', relief=GROOVE, command=exit)
btn_exit.place(x=815, y=620)
